...
class 생선가게POS기(QWidget):
    ...
    def UI초기화(self):
        ...
        # UI 초기화
        가로정렬 = QHBoxLayout() # 이 클래스는 수평 상자 레이아웃 개체를 구성하는 데 사용됩니다
    ...
    def 오늘(self):
        self.날짜 = QDate.currentDate() # 오늘 날짜를 받는다.
        ...
        가로정렬_오늘.addWidget(self.오늘매출, alignment=Qt.AlignRight) # alignment(얼라이언트) = 정렬, Qt.AlignRight = 오른쪽
        그룹박스_오늘.setLayout(가로정렬_오늘) # setLayout = 전체 레이아웃, 전체 레이아웃안에 넣는다.
        그룹박스_오늘.setFixedHeight(50) # '그룹박스_오늘' 의 높이를 50
